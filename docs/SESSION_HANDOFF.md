...
7. **Next:** owner live Lab CRUD/restart QA, then Phase D: copy both shared datasets to product `modules\...` paths, create new updater keys/GitHub Releases, publish the team installer, and retire standalone writers only after cutover is stable.

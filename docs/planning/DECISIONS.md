...
| IM-012 | Prefer a **whole redesign monorepo** (shared platform + domain modules) under this product, new GitHub repo, archive standalone repos after cutover—not perpetual triple-app maintenance. | TE redesign quality is the UX/ops baseline; do not force one row schema for all modules. GitHub `origin` connected 2026-07-18. **Implementation plan:** [../superpowers/plans/2026-07-20-platform-module-architecture-extract.md](../superpowers/plans/2026-07-20-platform-module-architecture-extract.md) (logical shell/platform/modules first; no multi-crate required in first extract). |

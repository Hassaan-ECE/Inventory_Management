...
| IM-006 | Default shared root for the implemented TE surface: `...\Inventory_Management_App\modules\TE_Test_Equipment`. | Override with `INVENTORY_MANAGEMENT_SHARED_ROOT`. Legacy TE share remains under InventoryApps until cutover. |

...
use crate::modules::te_lab_components::model::{InventoryEntry, InventorySharedStatus};

pub(crate) const SHARED_ROOT_ENV: &str = "INVENTORY_MANAGEMENT_LAB_COMPONENTS_SHARED_ROOT";
